...
public class UpdateAssignedUserSeleniumTest {

    ChromeDriver driver;
    private final String SCREENSHOTS = "./src/test/onDemandFeatureScreenshots/FeatureCreate";

    public UpdateAssignedUserSeleniumTest(ChromeDriver driver) {
        this.driver = driver;
    ...
    void test_Edit_feature() throws InterruptedException {
        ...
        assignedUser.selectByVisibleText("user");
    ...
    void Get_Feature_Details() throws InterruptedException{
        test_Edit_feature();
        driver.findElement(By.linkText("Updated Selenium Feature")).click();
        Thread.sleep(2000);
        WebElement success = driver.findElement(By.xpath("//*[contains(text(),'Updated Selenium Feature')]"));
        String successString = "Updated Selenium Feature";
        assertThat(success.getText(), is(successString));
    }
    ...
    void Check_Assigned_User_Test() throws InterruptedException{
        ...
        WebElement assignedUser = driver.findElement(By.xpath("//*[contains(text(),'Assigned to: user')]"));

        String successString = "Assigned to: user";
